package com.amvfunny.dev.wheelist.presentaition.widget.ratingbar;
...
public class CustomRatingBar extends ViewGroup {
    ...
    public static final int STAR_EMPTY = R.drawable.ic_star_inactive;
    public static final int STAR_HALF = R.drawable.ic_star_active;
    public static final int STAR_FULL = R.drawable.ic_star_active;
